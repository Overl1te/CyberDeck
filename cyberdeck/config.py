...
REMOTE_ACCESS_ENABLED = _env_bool("CYBERDECK_REMOTE_ACCESS_ENABLED", False)
PUBLIC_QR_ONLY = _env_bool("CYBERDECK_PUBLIC_QR_ONLY", REMOTE_ACCESS_ENABLED)
PUBLIC_ORIGIN_HINT = str(os.environ.get("CYBERDECK_PUBLIC_ORIGIN_HINT", "") or "").strip()
...
UPDATE_DOWNLOAD_TIMEOUT_S = _env_float("CYBERDECK_UPDATE_DOWNLOAD_TIMEOUT_S", 300.0)
UPDATE_DOWNLOAD_TIMEOUT_S = max(30.0, min(1800.0, UPDATE_DOWNLOAD_TIMEOUT_S))
LAUNCHER_PID = _env_int("CYBERDECK_LAUNCHER_PID", 0)
...
def reload_from_env() -> None:
    ...
    global ALLOW_QUERY_TOKEN, DEVICE_APPROVAL_REQUIRED, REMOTE_ACCESS_ENABLED, PUBLIC_QR_ONLY, PUBLIC_ORIGIN_HINT
    global CYBERDECK_GITHUB_REPO, CYBERDECK_MOBILE_GITHUB_REPO, MOBILE_VERSION, MOBILE_ANDROID_PACKAGE
    global UPDATE_CHECK_TIMEOUT_S, UPDATE_CHECK_TTL_S, UPDATE_DOWNLOAD_TIMEOUT_S, LAUNCHER_PID
    ...
    REMOTE_ACCESS_ENABLED = _env_bool("CYBERDECK_REMOTE_ACCESS_ENABLED", REMOTE_ACCESS_ENABLED)
    PUBLIC_QR_ONLY = _env_bool("CYBERDECK_PUBLIC_QR_ONLY", PUBLIC_QR_ONLY or REMOTE_ACCESS_ENABLED)
    PUBLIC_ORIGIN_HINT = str(os.environ.get("CYBERDECK_PUBLIC_ORIGIN_HINT", PUBLIC_ORIGIN_HINT or "") or "").strip()
    ...
    UPDATE_CHECK_TTL_S = max(15, min(3600, UPDATE_CHECK_TTL_S))
    UPDATE_DOWNLOAD_TIMEOUT_S = _env_float("CYBERDECK_UPDATE_DOWNLOAD_TIMEOUT_S", UPDATE_DOWNLOAD_TIMEOUT_S)
    UPDATE_DOWNLOAD_TIMEOUT_S = max(30.0, min(1800.0, UPDATE_DOWNLOAD_TIMEOUT_S))
    LAUNCHER_PID = _env_int("CYBERDECK_LAUNCHER_PID", LAUNCHER_PID)
