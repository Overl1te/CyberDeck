...
def setup_home_ui(app, ui: dict):
    ...
    app.lbl_version.pack(pady=(0, 4))
    app.lbl_updates = ctk.CTkLabel(info, text="Updates: not checked", font=FONT_SMALL, text_color=COLOR_TEXT_DIM)
    app.lbl_updates.pack(pady=(0, 10))
